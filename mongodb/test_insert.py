...
def main():
    ...
    insert_record: CarData = CarData(
        location=Location(
            Lattitude={"N": "60.15334714532838"}, Longitude={"N": "4.407109787976424"}
        ),
        speed=40,
    )
    # Printing the record's inserted_id to the console
    print(
        client["race-data"]["car-location"]
        .insert_one(insert_record.model_dump())
        .inserted_id
    )
